...
export class CubismEyeBlink {
  ...
  public static create(
    modelSetting: ICubismModelSetting | null = null
  ): CubismEyeBlink {
  ...
  public static delete(eyeBlink: CubismEyeBlink): void {
    // Note: In JavaScript/TypeScript, we cannot delete objects by setting parameters to null
    // This method exists for API compatibility but doesn't perform actual deletion
    if (eyeBlink != null) {
      // Objects are garbage collected automatically when no longer referenced
    }
  }
   ...
   * @param modelSetting モデルの設定情報
   */
  public constructor(modelSetting: ICubismModelSetting | null) {
